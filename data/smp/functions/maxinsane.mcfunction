execute as @a at @s unless score @s joined matches 1 run scoreboard players set @s[scores={sanityLevel=200}] stay200 1
execute as @a at @s unless score @s joined matches 1 run scoreboard players set @s[scores={sanityLevel=200}] firstdrain 1
