...
execute as @a[scores={sanityLevel=200,first200=1}] run tellraw @s {"text":"You have entered the Deep Starvation","color":"gray","hoverEvent":{"action":"show_text","contents":"You need to kill a player to depart from the Deep Starvation"}}
...
execute as @a[scores={sanityLevel=200}] at @s unless score @s joined matches 1 run effect give @s nausea 4 1 true
