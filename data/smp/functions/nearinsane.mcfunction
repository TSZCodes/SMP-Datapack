execute as @a[scores={sanityLevel=175..,first175=1}] at @s unless score @s joined matches 1 run tellraw @s {"text": "Your eyes start to feel tired...","hoverEvent": {"action": "show_text","value": "Reached 175 Points of Insanity"}}
