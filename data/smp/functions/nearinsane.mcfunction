...
execute as @a at @s[scores={sanityLevel=175..,first175=1}] unless score @s joined matches 1 run scoreboard players set @s first175 0
execute as @a at @s[scores={sanityLevel=175..199}] unless score @s joined matches 1 run effect give @s blindness 6 1 true
