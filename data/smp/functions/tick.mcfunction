...
execute as @a[scores={sanityLevel=200}] at @s if score @s sanityLevel matches 200 run scoreboard players set @s[scores={sanityLevel=200}] stay200 1
execute as @a[scores={sanityLevel=200}] at @s if score @s sanityLevel matches 200 run scoreboard players set @s[scores={sanityLevel=200}] firstdrain 1
